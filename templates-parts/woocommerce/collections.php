...
if (!empty($categories)) { ?>
    <div class="related-cat">
        <h2 class="text-center"><?php _e('Kupuj po Kolekcji', 'go'); ?></h2>
                        ...
                        <div class="related-cat__item">
                            <a href="<?php echo esc_url(get_term_link($category)); ?>">
                                <div class="item__images">
                                    <?php if (!$img && !$img2) { ?>
                                        <img src="<?php echo get_template_directory_uri(); ?>/src/img/thumbnail-call.png"
                                            alt="<?php echo esc_url(get_term_link($category)); ?> ">
                                    <?php } else { ?>
                                        <div class="img">
                                            <?php echo wp_get_attachment_image($img, 'collection-futured'); ?>
                                        </div>
                                        <div class="img img-2">
                                            <?php echo wp_get_attachment_image($img2, 'collection-futured'); ?>
                                        </div>
                                    <?php } ?>
                                </div>
                                <div class="item__content">
                                    <div class="title">
                                        <span><?php _e('Collection', 'go'); ?></span>
