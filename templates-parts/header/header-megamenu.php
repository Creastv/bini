                                    ...
                                    <div class="col">
                                        <div class="wraper-links">
                                            <?php while (have_rows('submenu', 'option')): the_row();
                                                $swicher = get_sub_field('link_swicher');
                                                $linki = get_sub_field('linki');
                                                $title = get_sub_field('tytul');
                                                $col = get_sub_field('kolumny');
                                                $tresc = get_sub_field('tresc');
                                                $separator = get_sub_field('separator');
                                                $styl = get_sub_field('styl');
                                            ?>
                                                <?php if ($swicher) { ?>
                                                    <div class="co <?php echo $col; ?> <?php echo $separator; ?>">
                                                        <?php if ($title) : ?>
                                                            <p class="wraper-links__title"><b><?php echo $title; ?></b></p>
                                                        <?php endif; ?>
                                                        <?php if ($linki) { ?>
